...
public class AnswersAdapterViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView tv_listanswer_vote;
    TextView tv_listanswer_numberofvotes;
    ...
    public AnswersAdapterViewHolder(View itemView) {
        ...
        tv_listanswer_vote = (TextView) itemView.findViewById(R.id.tv_listanswer_vote);
        tv_listanswer_numberofvotes = (TextView) itemView.findViewById(R.id.tv_listanswer_numberofvotes);
